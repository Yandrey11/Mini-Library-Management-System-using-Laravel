        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    @endif
                    <form action="{{ route('books.update', $book) }}" method="POST" class="space-y-4 max-w-md">
                        @csrf
                        @method('PUT')
                        <div>
                        ...
                        <div>
                            ...
                            <x-text-input id="total_inventory" name="total_inventory" type="number" min="0" class="mt-1 block w-full" :value="old('total_inventory', $book->total_inventory)" required />
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Available: {{ $book->available_inventory }} (currently borrowed)</p>
